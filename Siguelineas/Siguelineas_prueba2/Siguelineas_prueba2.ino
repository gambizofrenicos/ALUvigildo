...
/* PID */
float errores[NUM_SENSORS] = { -5.0, -3.0, -1.0, 1.0, 3.0, 5.0, 0.0, 0.0}; // valor del error asignado a cada sensor. Las alitas no suman error
...
void loop() {
  ...
  vbase = vmin+(vmax-vmin)*exp(-Kv*abs(Kp_line*e_line));
